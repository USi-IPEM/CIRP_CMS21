...
An explorative literature review on this matter reveals that publications that combine PA and QC became more relevant in the last 6 years. This could be in great part, due to computer power limitations in early research phase and the recent increase of ML applications in this area. Related works are mostly allocated into two groups, defects analysis of produced pieces and process oriented QC.
