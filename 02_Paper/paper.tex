...
off-line SPC procedures are aiming to select and choose a controllable product and process parameters to increase the quality of the outcoming product \cite{mitra2016fundamentals}.
...
The contrary method to any statistical method, is the hundred percent control, where every product is controlled and binary sorted as an OK or Non-OK part.
