...
Industrial projects requires to work with a variety of sensors and controllers. Thus, it might occurs incompatibility between technologies. In order to avoid that problem, universal protocols are often found at industrial projects. The industrial 4.0 demonstration cell data is shared via protocol OPC-UA. The Figure~\ref{fig:robot_pos_cell} describes a simplified version of the real connection diagram between sensors and controllers.
