...
%% Next paragraph: not relevant based on kkb : "First of all, you do not use a CBR approach because those have a clear methodology to follow with the minimum requirement to explain how your findings relate to further cases which i do not find in the paper. Then, you never pick up that though again after this point, so why mention it at all? I suggest you throw it out."
% For this, we applied a case-based research approach \cite{yin2017case} to answer the research questions.
