...
structure. In this case, we chose to train all three models using standard hyperparameters, which we found to work well. \footnote{To allow exact reproduction of our results source code is available at \url{https://github.com/manubrain/Demo-Cell-Classification}}
