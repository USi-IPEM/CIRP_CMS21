...
\aucores{* Corresponding author. Tel.: +49-271-740-2630; fax: +49-271-740-12628. {\it E-mail address:} fabian.steinberg@uni-siegen.de}
...
default hyperparameters, which we found to work well. \footnote{To allow exact reproduction of our results source code
...
\begin{table}
       ...
       \end{subtable}
       \caption{Confusion matrices result of the prediction of 50 test data-points. }
