...
\newcommand{\AP}[1]{{\color{green} {\bf (AP: #1)}}}
\newcommand{\LS}[1]{{\color{purple} {\bf (LS: #1)}}}
\newcommand{\MW}[1]{{\color{red} {\bf (MW: #1)}}}
\newcommand{\JG}[1]{{\color{orange} {\bf (JG: #1)}}}
...
% a)	How quality check is done in production
...
% Predictive analytics as concepts
...
% b)	Predictive analytics in production focusing in QA
