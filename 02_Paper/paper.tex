...
Finally, we present the findings achieved after the finalization of this project phase (Section~\ref{sec:conclusion}), as well as present a list of lessons learned for the implementation of the project, which might be helpful on further implementations (Section~\ref{sec:lessons}).
