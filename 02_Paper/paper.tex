...
The first step to collect the data is to list all the variables of interest and to map their source, see Table.~\ref{tab:data_source} . For this research, we focussed on the following data:
...
\begin{table}
       ...
       \begin{tabular}{ c c c } \toprule
              ...
              Conveyor speed       & Siemens PLC       & \begin{minipage}[c]{0.4\textwidth}
              \begin{description}
                     \item Conveyor-Gate 1
                     \item Conveyor-QC 2
                     \item Conveyor-Store/Magazine
                     \end{description}
                     \end{minipage} \\
              UR3 Position         & Siemens PLC       & \begin{minipage}[c]{0.4\textwidth}
              \begin{description}
                     \item $xyz$ Gripper position
                     \end{description}
                     \end{minipage} \\ 
              Action Flags         & Siemens PLC       & \begin{minipage}[c]{0.4\textwidth}
              \begin{description}
                     \item UR3 gripper open/close
                     \item Grab/drop disk based on disk type
                     \end{description}
                     \end{minipage} \\
              Quality control      & SICK SIM4000      & \begin{minipage}[c]{0.4\textwidth}
              \begin{description}
                     \item OK-NOK label
                     \item $xy$ disk deviation from center point
                     \item absolute disk deviation
                     \end{description}
                     \end{minipage} \\
              Gate position        & SICK SIM4000      & \begin{minipage}[c]{0.4\textwidth}
              \begin{description}
                     \item Position
                     \item Speed
                     \item Safe to go
                     \end{description}
                     \end{minipage} \\
              Store/Magazine       & SICK SIM4000      & \begin{minipage}[c]{0.4\textwidth}
                     \begin{description}
                     \item Disk Size
                     \end{description}
...
The data was collected manually by using the software "UAExperts"
